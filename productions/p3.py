...
def generate_p3_left_side_graph():
    ...
    graph.add_edges_from([
        ...
        (_UPPER_LEFT_ID, _UPPER_RIGHT_ID), (_UPPER_RIGHT_ID, _LOWER_RIGHT_ID), (_LOWER_RIGHT_ID, _LOWER_LEFT_ID), (_LOWER_LEFT_ID, _CENTER_LEFT_ID), (_CENTER_LEFT_ID, _UPPER_LEFT_ID),
    ])
