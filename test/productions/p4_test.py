...
from productions.p4 import p4, generate_p4_left_side_graph
...
class TestProduction4(unittest.TestCase):
    def test_p4(self):
        ...
        left_side = generate_p4_left_side_graph()
        p4(graph, p3_p4_strategy(graph, left_side))
    ...
    def test_p4_changed_cented_node_position_to_proper(self):
        graph = nx.Graph()
        graph.add_nodes_from(
            [(0, {'label': 'e', 'color': 'red'}),
             ...
             (7, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 1.5)}),
             (6, {'label': 'I', 'color': 'brown', 'level': 1, 'pos': (0.85, 0.55)})
             ]
        )
        graph.add_edges_from(
    ...
    def test_p4_changed_cented_node_position_to_invalid(self):
        graph = nx.Graph()
        graph.add_nodes_from(
            [(0, {'label': 'e', 'color': 'red'}),
             (1, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 2)}),
             ...
             (4, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (2, 0)}),
             (5, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (0.5, 1)}),
             (7, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 1.6)}),
             (6, {'label': 'I', 'color': 'brown', 'level': 1, 'pos': (0.85, 0.55)})
             ]
        )
        graph.add_edges_from(
    ...
    def test_p4_changed_label_to_invalid(self):
        graph = nx.Graph()
        graph.add_nodes_from(
            [(0, {'label': 'e', 'color': 'red'}),
             (1, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 2)}),
             (2, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 1)}),
             (3, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (0, 0)}),
             (4, {'label': 'X', 'color': 'blue', 'level': 1, 'pos': (2, 0)}),
             (5, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (0.5, 1)}),
             (7, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 1.5)}),
             (6, {'label': 'I', 'color': 'brown', 'level': 1, 'pos': (0.85, 0.55)})
             ]
    ...
    def test_p4_additional_node(self):
        graph = nx.Graph()
        graph.add_nodes_from(
            [(0, {'label': 'e', 'color': 'red'}),
             (1, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 2)}),
             ...
             (5, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (0.5, 1)}),
             (7, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 1.5)}),
             (21, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (2, 2)}),
             (6, {'label': 'I', 'color': 'brown', 'level': 1, 'pos': (0.85, 0.55)})
             ]
        )
        graph.add_edges_from(
    ...
    def test_p4_with_p3_graph(self):
        graph = nx.Graph()
        graph.add_nodes_from(
            [(1, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 2)}),
             (2, {'label': 'E', 'color': 'blue', 'level': 1, 'pos': (1, 1)}),
